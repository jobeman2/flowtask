...
export const envSchema = z.object({
  ...
  TELEGRAM_BOT_TOKEN: z.string().min(1, 'TELEGRAM_BOT_TOKEN is required in production').default('dev-dummy-token'),
  TELEGRAM_BOT_USERNAME: z.string().default('flowtaskmanager_bot'),
