      ...
      <div className="space-y-4 pb-24 font-sans animate-in fade-in duration-300">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="p-3 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-extrabold text-xs shadow-md shadow-purple-500/20 active:scale-98 transition-all flex items-center justify-center gap-1.5"
          >
                  ...
                  >
                    ...
                    {joinUrl && (
                      <a
                        ...
                        className="px-2.5 py-1.5 rounded-xl bg-purple-600 text-white text-[11px] font-bold flex items-center gap-1 shadow-xs hover:bg-purple-700 shrink-0"
                      >
                        <span>Join</span>
